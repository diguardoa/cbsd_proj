...
%             '/rfs_191_',int2str(i),'.txt'));
        ...
        temp_190=importfile1(strcat('../cpu1_rate',int2str(rate),'_conn',int2str(conn), ...
            '/rfs_190_',int2str(i),'.txt'));
        ...
        temp_191=importfile1(strcat('../cpu1_rate',int2str(rate),'_conn',int2str(conn), ...
                '/rfs_191_',int2str(i),'.txt'));
...
legend('1 cpu', 'errors', 'physical limit');
xlabel('rate (Hz)');
ylabel('t [s] | #');


%% comandi da installare
% dstat